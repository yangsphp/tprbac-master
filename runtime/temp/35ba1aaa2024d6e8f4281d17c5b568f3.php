<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"D:\phpStudy\WWW\tpshop\public/../application/admin\view\role\edit.html";i:1585190950;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="layui-tab page-content-wrap">
    ...
    <div class="layui-tab-content">
        <div class="layui-tab-item layui-show">
            <form class="layui-form" style="width: 90%;padding-top: 20px;" action="<?php echo url('role/edit'); ?>" method="post">
                <div class="layui-form-item">
                    <label class="layui-form-label"><span style="color: #f00;">*</span> 角色名称：</label>
                    <div class="layui-input-block">
                        <input type="text" name="post[name]" lay-verify="required" lay-reqtext="角色名称是必填项" autocomplete="off" class="layui-input" placeholder="请输入角色名称" value="<?php echo $info['name']; ?>">
                    </div>
                </div>
                <div class="layui-form-item layui-form-text">
                    <label class="layui-form-label">备注：</label>
                    <div class="layui-input-block">
                        <textarea name="post[note]" placeholder="请输入角色备注" class="layui-textarea"><?php echo $info['note']; ?></textarea>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text">
...
<script>
    layui.config({
        base: 'http://localhost/tpshop/public/static/admin/layui/lay/modules/',
    }).extend({
        authtree: 'authtree',
    });
</script>
<script>
    layui.use(['form', 'element', 'authtree'], function() {
        ...
        authtree.render('#tree', <?php echo $tree; ?>, {
            ...
            themePath: 'http://localhost/tpshop/public/static/admin/layui/lay/themes/' // 主题路径，默认 layui_exts/tree_themes/
        });
        //监听信息提交
