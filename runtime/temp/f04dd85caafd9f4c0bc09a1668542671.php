<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"D:\phpStudy\WWW\tpshop\public/../application/admin\view\menu\add.html";i:1585121376;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="layui-tab page-content-wrap">
    <ul class="layui-tab-title">
        <li>
            <a href="<?php echo url('menu/index'); ?>">菜单列表</a>
        </li>
        <li class="layui-this">添加菜单</li>
    </ul>
    <div class="layui-tab-content">
        <div class="layui-tab-item layui-show">
            <form class="layui-form" style="width: 90%;padding-top: 20px;" action="<?php echo url('menu/add'); ?>" method="post">
