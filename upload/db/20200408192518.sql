...
-- Records of tp_admin
-- --------------------
insert into `tp_admin` (`id`,`username`,`password`,`salt`,`date_entered`,`login_entered`,`last_login_entered`,`login_ip`,`role_id`,`status`,`times`) values ('1','admin','ef0fdc8b1d6c53a971dbe905e4393018','ABCDE','2019-08-20 13:07:38','2020-04-03 21:05:07','2020-03-30 19:31:58','0.0.0.0','1','1','11');
...
insert into `tp_back_up` (`id`,`user_id`,`name`,`table`,`path`,`size`,`date_entered`) values ('18','1','20200404145353.sql','tp_admin','/upload/db/20200404145353.sql','0.67KB','2020-04-04 14:53:53');
-- --------------------
-- Records of tp_role
-- --------------------
